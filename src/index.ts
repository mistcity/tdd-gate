...
import type { PreToolUseInput, StopInput, HookInput } from './types.js';
...
export function route(
  ...
  switch (input.hook_event_name) {
    case 'PreToolUse': {
      ...
      return handlePreToolUse(input as PreToolUseInput, config, journal, cb);
    }
    ...
    case 'Stop': {
      ...
      if (stopInput.stop_hook_active) return { action: 'allow' };
